  ...
  return (
    <div className="detailmain">
            ...
            <div className="dproductdetails">
                ...
                <h4 style={{ textAlign: "left" }}><span><b>About this item  :-   </b> </span><br/><br/>{details.description}</h4><br/>
             <h4 style={{ textAlign: "left" }}><span><b>Company Name   :-   </b> </span>{details.company_name}</h4>
